<nav class="col-md-2 d-none d-md-block sidebar dashboard-sidebar-navbar">
    <div class="sidebar-sticky">
        <ul class="nav flex-column admin-sidebar-ul">
            ...
            <li class="nav-item dashboard-sidebar-item">
                <a class="nav-link admin-sidebar-link" href="{{ route('product-inventory.index') }}"><img class="product_inventory_icon img-icons" src="/images/icons/inventory-white(2).png" alt="product_inventory_icon">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Product Inventory</a>
            </li>
            <li class="nav-item dashboard-sidebar-item">
